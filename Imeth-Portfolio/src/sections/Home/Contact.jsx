    ...
    <div className="relative w-full pt-15 md:min-w-[945px] flex flex-col items-center text-white pt-[3%]">
      ...
      <div className="w-full flex flex-col md:flex-row justify-between px-8 md:px-16 mt-8 md:mt-16">
        <div className="w-full flex flex-col md:flex-row items-center md:items-start">
          ...
          <h1 className="text-[200%] md:text-[400%] font-bold mt-8 md:mt-5 md:ml-20 text-center md:text-left font-poppins">
            Let’s Work Together!
          </h1>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col md:flex-row justify-center items-center mt-12 md:mt-20 space-y-6 md:space-y-0 md:space-x-20">
        <button className="flex items-center border border-white py-2 px-4 md:py-4 md:px-6 rounded-md text-white text-xl font-pontano">
        ...
        <a
          ...
          className="flex items-center border border-white py-2 px-4 md:py-4 md:px-6 rounded-md text-white text-xl font-pontano"
        >
          <img src={Download} alt="Email" className="w-5 h-5 mr-2" />
