...
function Projects() {
  ...
  return (
    <div className="relative w-screen pt-15 md:min-w-[945px] flex flex-col items-center text-white pt-[3%]">
      {/* Row 1: Heading */}
      <div
        className="w-full flex flex-col items-end px-8 md:px-16 pt-8 md:pt-16"
        data-aos="fade-left"
      ...
      <div
        className="w-full flex flex-col md:flex-row justify-between pr-8 md:pr-16"
        data-aos="fade-left"
      ...
      >
        ...
        <div
          className="w-full md:w-[50%] flex flex-col items-start mt-6 md:mt-0 pl-8"
          data-aos="fade-left"
          data-aos-duration="2500"
        >
          ...
          <Link to="/projects" data-aos="fade-left" data-aos-duration="2500">
            <img
